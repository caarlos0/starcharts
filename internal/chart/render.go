...
func (c *Chart) Render(w io.Writer) {
	...
	svgElement := svg.SVG().
		...
		Attr("height", svg.Px(DefaultChartWidth)).
		Content(styleElement.String()).
		Content(path.String())
